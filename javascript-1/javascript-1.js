...
for(let i=0;i<lettersToPair.length;i++){
    ...
    // console.log(lettersToPair.findIndex(letter=> letter === lettersToPair[i]),i)
    if(lettersToPair.findIndex(letter=> letter === lettersToPair[i])!==i){
      pairsArray.push([lettersToPair.findIndex(letter=> letter === lettersToPair[i]),i])
    }
...
/*
    ...
    You will give context to 'bark' using the .call metho-d.
...
//CODE HERE
    console.log(fido)
    let things =['chicken','tennis ball']
...
//CODE HERE
  let phone1 = new Phone("a",'aple',32,'black',true)
    
  let phone2 = new Phone("s",'galaxy',64,'black',false)
  
 let phone3 = new Phone("c",'goog',128,'black',false)
